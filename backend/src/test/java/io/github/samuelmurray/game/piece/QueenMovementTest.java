...
class QueenMovementTest {
    ...
    void testGetValidMovesInCorner() {
        ...
        Set<Position> validMoves = queenMovement.getPotentiallyValidMoves(A1, gameState);
    ...
    void testGetValidMovesInMiddle() {
        GameState gameState = GameState.of(Collections.emptyMap());
        Set<Position> validMoves = queenMovement.getPotentiallyValidMoves(C3, gameState);
